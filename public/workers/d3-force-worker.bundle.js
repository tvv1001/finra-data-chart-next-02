...
!(function (n, t) {
	'object' == typeof exports && 'undefined' != typeof module ? t(exports, require('d3-quadtree'), require('d3-dispatch'), require('d3-timer'))
	: 'function' == typeof define && define.amd ? define(['exports', 'd3-quadtree', 'd3-dispatch', 'd3-timer'], t)
	: t(((n = 'undefined' != typeof globalThis ? globalThis : n || self).d3 = n.d3 || {}), n.d3, n.d3, n.d3);
	...
	((n.forceCenter = function (n, t) {
		...
		(n.forceCollide = function (n) {
			var e,
				...
				l = 1;
			function h() {
				for (var n, i, h, y, d, g, x, s = e.length, p = 0; p < l; ++p)
					for (i = t.quadtree(e, o, f).visitAfter(v), n = 0; n < s; ++n) ((h = e[n]), (g = r[h.index]), (x = g * g), (y = h.x + h.vx), (d = h.y + h.vy), i.visit(M));
			...
			return (
				'function' != typeof n && (n = i(null == n ? 1 : +n)),
				(h.initialize = function (n, t) {
					((e = n), (a = t), y());
				}),
		...
		(n.forceLink = function (n) {
				...
				for (var i = 0, o = n.length; i < d; ++i)
					for (var a, c, h, v, y, g, x, s = 0; s < o; ++s)
						((c = (a = n[s]).source),
							...
							(v *= g = (((g = Math.sqrt(v * v + y * y)) - e[s]) / g) * r * t[s]),
							(y *= g),
							(h.vx -= v * (x = f[s])),
							(h.vy -= y * x),
							(c.vx += v * (x = 1 - x)),
			...
			function x() {
				if (r) {
					...
					for (i = 0, o = new Array(a); i < l; ++i)
						(((u = n[i]).index = i),
							'object' != typeof u.source && (u.source = c(v, u.source)),
							'object' != typeof u.target && (u.target = c(v, u.target)),
			...
			function s() {
				if (r) for (var e = 0, i = n.length; e < i; ++e) t[e] = +v(n[e], e, n);
			}
			function p() {
				if (r) for (var t = 0, i = n.length; t < i; ++t) e[t] = +y(n[t], t, n);
			}
			return (
				null == n && (n = []),
		...
		(n.forceManyBody = function () {
			...
			function d(r) {
				var i,
					...
					p,
					s,
					n = t.quadtree(e, h, v).visitAfter(g);
			...
			function x(e) {
				...
				for (var h = 0; h < e; ++h)
					for (
						...
						(null == (u = n[r]).fx ? (u.x += u.vx *= a) : ((u.x = u.fx), (u.vx = 0)), null == u.fy ? (u.y += u.vy *= a) : ((u.y = u.fy), (u.vy = 0)));
				return t;
			}
			function s() {
		...
		(n.forceX = function (n) {
			...
			return (
				'function' != typeof n && (n = i(null == n ? 0 : +n)),
